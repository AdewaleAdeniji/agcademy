        ...
        <div className="footer">
            ...
            <div className='footer-desc'>
                ...
                <div className='social-links'>
                    <a className='twitter'>
                        <img src={require('../../assets/twitter.svg')} alt="Twitter social"/>
                    </a>
                    <a className='linkedin'>
                        <img src={require('../../assets/linkedin.svg')} alt="linkedin social"/>
                    </a>
                    <a className='facebook'>
                        <img src={require('../../assets/facebook.svg')} alt="facebook social"/>
                    </a>
                    <a className='instagram'>
                        <img src={require('../../assets/instagram.svg')} alt="instagram social"/>
                    </a>
                </div>
            </div>
        </div>
